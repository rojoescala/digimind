package escalante.roberto.digimind.ui.dashboard
...
import escalante.roberto.digimind.ui.home.HomeFragment
...
class DashboardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        root.btn_save.setOnClickListener{
            ...
            var tasks = Task(title, days, time)

            HomeFragment.tasks.add(tasks)
